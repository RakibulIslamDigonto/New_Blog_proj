"""
Django settings for New_Blog_prj project.
...
SECRET_KEY = 'django-insecure-9%64m*p63#0&bo*iz_8-6v36_)1ah3^@th!-zk%#6b+zv*ro^c'
...
ROOT_URLCONF = 'New_Blog_prj.urls'
...
WSGI_APPLICATION = 'New_Blog_prj.wsgi.application'
